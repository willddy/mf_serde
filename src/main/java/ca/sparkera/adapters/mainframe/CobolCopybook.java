...
public class CobolCopybook {
	...
	public CobolCopybook(String layout) {
		/*
		 * Split the cobol layout separate lines using ". " as delimiter, space
		 * is also included because dot can also occur in between Picture clause.
		 */
	...
	private void buildLayout() throws CobolSerdeException {
		...
		for (String fieldLine : fieldLines) {
            ...
            /*
             The 88 level does not define a field, and does not take space in the record;
             It is merely a value definition. Therefore, ignore it.
              */
			if (cfd.levelNo == 88)
				continue;
